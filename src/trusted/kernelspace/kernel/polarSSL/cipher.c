...
#if defined(POLARSSL_AES_C)
    if( !strncasecmp( "AES-128-CBC", cipher_name, strlen("AES-128-CBC") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_128_CBC );
    if( !strncasecmp( "AES-192-CBC", cipher_name, strlen("AES-192-CBC") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_192_CBC );
    if( !strncasecmp( "AES-256-CBC", cipher_name, strlen("AES-256-CBC") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_256_CBC );

#if defined(POLARSSL_CIPHER_MODE_CFB)
    if( !strncasecmp( "AES-128-CFB128", cipher_name, strlen("AES-128-CFB128") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_128_CFB128 );
    if( !strncasecmp( "AES-192-CFB128", cipher_name, strlen("AES-192-CFB128") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_192_CFB128 );
    if( !strncasecmp( "AES-256-CFB128", cipher_name, strlen("AES-256-CFB128") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_256_CFB128 );
#endif /* defined(POLARSSL_CIPHER_MODE_CFB) */

#if defined(POLARSSL_CIPHER_MODE_CTR)
    if( !strncasecmp( "AES-128-CTR", cipher_name, strlen("AES-128-CTR") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_128_CTR );
    if( !strncasecmp( "AES-192-CTR", cipher_name, strlen("AES-192-CTR") ) )
        return cipher_info_from_type( POLARSSL_CIPHER_AES_192_CTR );
    if( !strncasecmp( "AES-256-CTR", cipher_name, strlen("AES-256-CTR") ) )
...
#if defined(POLARSSL_CIPHER_NULL_CIPHER)
    if( !strncasecmp( "NULL", cipher_name, strlen("NULL") ) )
