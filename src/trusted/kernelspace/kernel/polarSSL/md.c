...
#endif
#if defined(POLARSSL_MD5_C)
    if( !strncasecmp( "MD5", md_name, strlen("MD5") ) )
        return md_info_from_type( POLARSSL_MD_MD5 );
#endif
#if defined(POLARSSL_SHA1_C)
    if( !strncasecmp( "SHA1", md_name, strlen("SHA1") ) || !strncasecmp( "SHA", md_name, strlen("SHA") ) )
        return md_info_from_type( POLARSSL_MD_SHA1 );
#endif
#if defined(POLARSSL_SHA2_C)
    if( !strncasecmp( "SHA224", md_name, strlen("SHA224") ) )
        return md_info_from_type( POLARSSL_MD_SHA224 );
    if( !strncasecmp( "SHA256", md_name, strlen("SHA256") ) )
        return md_info_from_type( POLARSSL_MD_SHA256 );
#endif
#if defined(POLARSSL_SHA4_C)
    if( !strncasecmp( "SHA384", md_name, strlen("SHA384") ) )
        return md_info_from_type( POLARSSL_MD_SHA384 );
    if( !strncasecmp( "SHA512", md_name, strlen("SHA512") ) )
